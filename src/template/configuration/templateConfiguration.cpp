...
//ADSP_INRESMOD_MODE_NUM adspInResampleModeNum[ADSP_MAX_INRES_MODES] = {INPUTRESAMPLE_MODE1_ID};
...
//ADSP_OUTRESMOD_MODE_NUM adspOutResampleModeNum = OUTPUTRESAMPLE_MODE1_ID;
